...
CONF_DIR="${PROJECT_HOME}/conf_cluster2"
mkdir -p ${CONF_DIR}
...
OUTPUT_DATA_DIR="${PROJECT_HOME}/dynamic_lin2/"
...
#NUM_NODES_LIST=( 100 )
#NET_TYPE_LIST=('full' 'erdos-renyi' 'barabasi-albert' 'space')
NET_TYPE_LIST=('space')
