...
OUTPUT_DATA_DIR="${PROJECT_HOME}/deadlock3/"
...
NUM_EDGES=3
INTERACTION_RADIUS_LIST=($(seq 0.2 0.05 0.5))
						...
						do
							...
							do
								...
								do
									...
									JOB_PARAM="net-${NET_TYPE}_nodes-${NUM_NODES}_range-${INTERACTION_RADIUS}_link-${LINK_PROBABILITY}_model-${DEC_MODEL}_up-${UPDATE_CONF}_acc-${ACC_MEAN}_acstdv-${ACC_STD_DEV}_eps-${BELIEF_EPSILON}"
