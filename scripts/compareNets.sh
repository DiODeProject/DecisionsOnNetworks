...
OUTPUT_DATA_DIR="${PROJECT_HOME}/nets2/"
...
LINK_PROBABILITY_LIST=($(seq 0.1 0.1 0.6))
NUM_EDGES_LIST=($(seq 2 2 10))

ACC_MEAN_LIST=( 0.6 0.7 )
				...
				do
					...
					do
						...
						do
							...
							JOB_PARAM="net-${NET_TYPE}_nodes-${NUM_NODES}_edges-${NUM_EDGES}_link-${LINK_PROBABILITY}_model-${DEC_MODEL}_acc-${ACC_MEAN}_acstdv-${ACC_STD_DEV}"
