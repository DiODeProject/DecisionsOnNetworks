...
OUTPUT_DATA_DIR="${PROJECT_HOME}/static3/"
...
#UPDATE_CONF_LIST=( 'optim-up' 'belief-up' 'finite-time')
...
BELIEF_EPSILON_LIST=($(seq 0.001 0.003 0.007))
									...
									do
										...
										do
											...
											do
												...
												JOB_PARAM="net-${NET_TYPE}_nodes-${NUM_NODES}_edges-${NUM_EDGES}_link-${LINK_PROBABILITY}_bound-${PERIODICBOUND}_env-${ENV_SIZE}_model-${DEC_MODEL}_up-${UPDATE_CONF}_acc-${ACC_MEAN}_acstdv-${ACC_STD_DEV}_eps-${BELIEF_EPSILON}"
