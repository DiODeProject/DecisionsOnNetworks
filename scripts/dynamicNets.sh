...
OUTPUT_DATA_DIR="${PROJECT_HOME}/dynamic6/"
...
#ENV_SIZE_LIST=(0.01 0.1 1 10 100)
								...
								do
									...
									do
										...
										do
											...
											JOB_PARAM="net-${NET_TYPE}_nodes-${NUM_NODES}_range-${INTERACTION_RADIUS}_link-${LINK_PROBABILITY}_dyn-${DYNAMICNET}_speed-${AGENTSPEED}_stddev-${MOVE_STDDEV}_bound-${PERIODICBOUND}_env-${ENV_SIZE}_model-${DEC_MODEL}_up-${UPDATE_CONF}_acc-${ACC_MEAN}_acstdv-${ACC_STD_DEV}_eps-${BELIEF_EPSILON}"
